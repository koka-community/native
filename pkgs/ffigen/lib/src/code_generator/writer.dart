...
class Writer {
  ...
  String generate() {
    ...
    result.write(
        makeDoc('AUTO GENERATED FILE, DO NOT EDIT.\n\nGenerated by `ffigen`.'));
    ...
    if (lookUpBindings.isNotEmpty) {
      ...
      if (classDocComment != null) {
        s.write(makeDoc(classDocComment!));
      }
      // Write wrapper classs.
      s.write('// Holds the symbols from the dynamic library.\n');
      s.writeln('struct $_className');
      s.writeln('  // The symbols are looked up in `lib`.');
      s.writeln('  lib: dynlib');
